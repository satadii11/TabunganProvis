...
public class LoginView extends BaseView {
    ...
    private void initComponents() {
        ...
        tfUsername.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N

        pfPassword.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       if (tfUsername.getText().equals("tabungan-admin") && 
               String.valueOf(pfPassword.getPassword()).equals("adminunikom")) {
           new MainMenuView().setVisible(true);
           setVisible(false);
       } else {
           showDialog("Gagal melakukan login. Silakan cek username dan password anda");
       }
